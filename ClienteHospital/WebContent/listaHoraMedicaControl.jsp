...
<title>Lista Hora Medica de Control</title>
...
<body>
	...
	<div>
		<h1>Horas Médicas De Control</h1>
		<div class="busqueda">
			...
			<fieldset>
				...
				<form action="BuscarHoraMedicaControl" method="post">
					<p>
				...
				<a href="listaHoraMedicaControl.jsp"><button>Recargar</button></a>
			</fieldset>
		...
		<div id="contenedorTabla">
			...
			<fieldset>
				<legend>
					<h1>Lista Horas Médicas Control</h1>
				</legend>
				<center>
					<table>
						<thead>
