	...
	<div class="contenedorGeneral">
		<div class="busqueda">
			<p class="contenedorBusqueda">
				<input type="search" name="busqueda" class="input_busqueda"
					placeholder="buscar por medico..." />
				<button class="btn_busqueda" id="trabajadoresBusqueda">buscar</button>
			</p>

			<p class="buscarPorFecha">
				fecha Inicio:<input class="fechaInicio" type="date" /> fecha Fin:<input
					class="fechaTermino" type="date" />
			</p>
		</div>
