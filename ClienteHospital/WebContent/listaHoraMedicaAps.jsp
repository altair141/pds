	...
	<div>
		...
		<div class="busqueda">
			...
			<fieldset>
				...
				<form action="BuscarHoraMedicaAps" method="post">
					<p>
				...
				<a href="listaHoraMedicaAps.jsp"><button>Recargar</button></a>
			</fieldset>
